...
if($result &&  $result->num_rows > 0){
 ...
 echo("<strong><p style='color:red;'> Password Does not match our records </p></strong>");
   ...
   echo ("<script> setTimeout(function(){ window.location.replace('http://cyan.csam.montclair.edu/~pearts1/DatabaseProject/AdminLogIn.php')}, 5000);</script>");
...
echo ("<script> setTimeout(function(){ window.location.replace('http://cyan.csam.montclair.edu/~pearts1/DatabaseProject/AdminSignUp.php')}, 5000);</script>");
