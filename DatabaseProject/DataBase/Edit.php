...
error_reporting(0);
 ...
 echo("<strong>you dont have access to route forbiden </strong>");
 	echo ("<script> setTimeout(function(){ window.location.replace('http://cyan.csam.montclair.edu/~willia55/DatabaseProject/')}, 5000);</script>");
...
include 'connect.php';
  ...
  <td><input type="text" name="Zipcode" value='.$row['zipcode'].' required></td>
   ...
   if ( $_SESSION["roll"] == "Student"){
   	 ...
   	 echo ' <td><select name="Year" required>
